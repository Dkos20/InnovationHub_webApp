...
var ArrowDown = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 9 16"><path d="M4.5,13c-.28,0-.5-.22-.5-.5V3.5c0-.28,.22-.5,.5-.5s.5,.22,.5,.5V12.5c0,.28-.22,.5-.5,.5Z" fill="currentColor"/><path d="M4.5,14c-.13,0-.26-.05-.35-.15L.65,10.35c-.2-.2-.2-.51,0-.71,.2-.2,.51-.2,.71,0l3.15,3.15,3.15-3.15c.2-.2,.51-.2,.71,0,.2,.2,.2,.51,0,.71l-3.5,3.5c-.1,.1-.23,.15-.35,.15Z" fill="currentColor"/></svg>`;

var ArrowLeft = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 9"><path d="M12.5,5H3.5c-.28,0-.5-.22-.5-.5s.22-.5,.5-.5H12.5c.28,0,.5,.22,.5,.5s-.22,.5-.5,.5Z" fill="currentColor"/><path d="M6,8.5c-.13,0-.26-.05-.35-.15l-3.5-3.5c-.2-.2-.2-.51,0-.71L5.65,.65c.2-.2,.51-.2,.71,0,.2,.2,.2,.51,0,.71l-3.15,3.15,3.15,3.15c.2,.2,.2,.51,0,.71-.1,.1-.23,.15-.35,.15Z" fill="currentColor"/></svg>`;

var ArrowRight = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 9"><path d="M12.5,5H3.5c-.28,0-.5-.22-.5-.5s.22-.5,.5-.5H12.5c.28,0,.5,.22,.5,.5s-.22,.5-.5,.5Z" fill="currentColor"/><path d="M10,8.5c-.13,0-.26-.05-.35-.15-.2-.2-.2-.51,0-.71l3.15-3.15-3.15-3.15c-.2-.2-.2-.51,0-.71,.2-.2,.51-.2,.71,0l3.5,3.5c.2,.2,.2,.51,0,.71l-3.5,3.5c-.1,.1-.23,.15-.35,.15Z" fill="currentColor"/></svg>`;

var ArrowUp = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 9 16"><path d="M4.5,14c-.28,0-.5-.22-.5-.5V4.5c0-.28,.22-.5,.5-.5s.5,.22,.5,.5V13.5c0,.28-.22,.5-.5,.5Z" fill="currentColor"/><path d="M8,7.5c-.13,0-.26-.05-.35-.15l-3.15-3.15L1.35,7.35c-.2,.2-.51,.2-.71,0-.2-.2-.2-.51,0-.71l3.5-3.5c.2-.2,.51-.2,.71,0l3.5,3.5c.2,.2,.2,.51,0,.71-.1,.1-.23,.15-.35,.15Z" fill="currentColor"/></svg>`;

var CaretDown = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 9"><path d="M7.18,7.62L3.03,2.79c-.6-.7-.1-1.79,.82-1.79H12.14c.93,0,1.42,1.09,.82,1.79l-4.14,4.83c-.43,.5-1.21,.5-1.64,0Z" fill="currentColor"/></svg>`;

var CaretLeft = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 9 16"><path d="M1.38,7.18L6.21,3.03c.7-.6,1.79-.1,1.79,.82V12.14c0,.93-1.09,1.42-1.79,.82L1.38,8.82c-.5-.43-.5-1.21,0-1.64Z" fill="currentColor"/></svg>`;

var CaretRight = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 9 16"><path d="M7.62,7.18L2.79,3.03c-.7-.6-1.79-.1-1.79,.82V12.14c0,.93,1.09,1.42,1.79,.82l4.83-4.14c.5-.43,.5-1.21,0-1.64Z" fill="currentColor"/></svg>`;

var CaretUp = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 9"><path d="M7.18,1.38L3.03,6.21c-.6,.7-.1,1.79,.82,1.79H12.14c.93,0,1.42-1.09,.82-1.79L8.82,1.38c-.43-.5-1.21-.5-1.64,0Z" fill="currentColor"/></svg>`;

var Down = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 7"><path d="M8,6.5c-.13,0-.26-.05-.35-.15L3.15,1.85c-.2-.2-.2-.51,0-.71,.2-.2,.51-.2,.71,0l4.15,4.15L12.15,1.15c.2-.2,.51-.2,.71,0,.2,.2,.2,.51,0,.71l-4.5,4.5c-.1,.1-.23,.15-.35,.15Z" fill="currentColor"/></svg>`;

var Left = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 7 16"><path d="M5.5,13c-.13,0-.26-.05-.35-.15L.65,8.35c-.2-.2-.2-.51,0-.71L5.15,3.15c.2-.2,.51-.2,.71,0,.2,.2,.2,.51,0,.71L1.71,8l4.15,4.15c.2,.2,.2,.51,0,.71-.1,.1-.23,.15-.35,.15Z" fill="currentColor"/></svg>`;

var Right = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 7 16"><path d="M1.5,13c-.13,0-.26-.05-.35-.15-.2-.2-.2-.51,0-.71l4.15-4.15L1.15,3.85c-.2-.2-.2-.51,0-.71,.2-.2,.51-.2,.71,0L6.35,7.65c.2,.2,.2,.51,0,.71L1.85,12.85c-.1,.1-.23,.15-.35,.15Z" fill="currentColor"/></svg>`;

var Up = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 7"><path d="M12.5,6c-.13,0-.26-.05-.35-.15L8,1.71,3.85,5.85c-.2,.2-.51,.2-.71,0-.2-.2-.2-.51,0-.71L7.65,.65c.2-.2,.51-.2,.71,0l4.5,4.5c.2,.2,.2,.51,0,.71-.1,.1-.23,.15-.35,.15Z" fill="currentColor"/></svg>`;
...
var Button = `<svg viewBox="0 0 44 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M4 3H40C40.5523 3 41 3.44771 41 4V20C41 20.5523 40.5523 21 40 21H4C3.44772 21 3 20.5523 3 20V4C3 3.44772 3.44772 3 4 3ZM0 4C0 1.79086 1.79086 0 4 0H40C42.2091 0 44 1.79086 44 4V20C44 22.2091 42.2091 24 40 24H4C1.79086 24 0 22.2091 0 20V4ZM12 10.5C11.1716 10.5 10.5 11.1716 10.5 12C10.5 12.8284 11.1716 13.5 12 13.5H32C32.8284 13.5 33.5 12.8284 33.5 12C33.5 11.1716 32.8284 10.5 32 10.5H12Z" fill="currentColor" /></svg>`;

var Checkbox = `<svg viewBox="0 0 44 44" xmlns="http://www.w3.org/2000/svg"><rect x="1.5" y="1.5" width="41" height="41" rx="2.5" stroke="currentColor" stroke-width="3" fill="none" /><path d="M17.758 26.2542L30.9563 13.0426L33.3151 15.4013L17.7586 30.9578L10.6875 23.8867L13.0456 21.5285L17.758 26.2542Z" fill="currentColor"/></svg>`;

var Color = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M5.5,14H2.5c-.28,0-.5-.22-.5-.5v-3c0-.13,.05-.26,.15-.35L7.15,5.15c.2-.2,.51-.2,.71,0l3,3c.2,.2,.2,.51,0,.71l-5,5c-.09,.09-.22,.15-.35,.15Zm-2.5-1h2.29l4.5-4.5-2.29-2.29L3,10.71v2.29Z" fill="currentColor"/><path d="M13.37,5.62l-1.38,1.38-3-3,1.38-1.38c.42-.42,.96-.62,1.5-.62s1.08,.2,1.5,.62c.83,.83,.83,2.17,0,3Z" fill="currentColor"/><path d="M12.5,8c-.13,0-.26-.05-.35-.15L8.15,3.85c-.2-.2-.2-.51,0-.71,.2-.2,.51-.2,.71,0l4,4c.2,.2,.2,.51,0,.71-.1,.1-.23,.15-.35,.15Z" fill="currentColor"/></svg>`;
...
export { Add as add, Amex as amex, Android as android, Apple as apple, index$7 as applicationIcons, ArrowDown as arrowDown, ArrowLeft as arrowLeft, ArrowRight as arrowRight, ArrowUp as arrowUp, AvatarMan as avatarMan, AvatarWoman as avatarWoman, Bitcoin as bitcoin, Bnb as bnb, Bookmark as bookmark, index$6 as brandIcons, Button as button, Cardano as cardano, CaretDown as caretDown, CaretLeft as caretLeft, CaretRight as caretRight, CaretUp as caretUp, Check as check, Checkbox as checkbox, Circle as circle, Close as close, Color as color, Compress as compress, index$5 as cryptoIcons, index$4 as currencyIcons, Date as date, Datetime as datetime, icons as default, index$3 as directionalIcons, Discover as discover, Dogecoin as dogecoin, Dollar as dollar, Down as down, Download as download, DownloadCloud as downloadCloud, Email as email, Ethereum as ethereum, Euro as euro, Expand as expand, Export as exportAction, Eye as eye, EyeClosed as eyeClosed, Facebook as facebook, FastForward as fastForward, File as file, FileAudio as fileAudio, FileDoc as fileDoc, index$2 as fileIcons, FileImage as fileImage, FilePdf as filePdf, FileVideo as fileVideo, Flag as flag, Folder as folder, Franc as franc, Github as github, Group as group, Happy as happy, Heart as heart, Help as help, Hidden as hidden, Info as info, index$1 as inputIcons, Instagram as instagram, Krona as krona, Left as left, Link as link, LinkExternal as linkExternal, Linkedin as linkedin, Lira as lira, List as list, Search$1 as magnifyingGlass, Mastercard as mastercard, Medium as medium, Megaphone as megaphone, Minimize as minimize, Month as month, MultiCurrency as multiCurrency, Number as number, Open as open, Password as password, Pause as pause, index as paymentIcons, Paypal as paypal, People as people, Peso as peso, Pinterest as pinterest, Play as play, PlayCircle as playCircle, Pound as pound, Radio as radio, Range as range, Reddit as reddit, Refresh as refresh, Reorder as reorder, Repeater as repeater, Reply as reply, Rewind as rewind, Right as right, Ruble as ruble, Rupee as rupee, Sad as sad, Search as search, Select as select, Settings as settings, Share as share, Shekel as shekel, Skype as skype, Snapchat as snapchat, Solana as solana, Spinner as spinner, Star as star, Start as start, StepBack as stepBack, StepForward as stepForward, Stop as stop, Stripe as stripe, Submit as submit, Tag as tag, Telephone as telephone, Tether as tether, Text as text, Textarea as textarea, Tiktok as tiktok, Time as time, Tools as tools, Trash as trash, Up as up, Upload as upload, UploadCloud as uploadCloud, URL as url, Usdc as usdc, Vimeo as vimeo, Visa as visa, VolumeDown as volumeDown, VolumeUp as volumeUp, Warning as warning, Week as week, Whatsapp as whatsapp, Won as won, Wordpress as wordpress, Yen as yen, Youtube as youtube, Yuan as yuan, Zip as zip };
