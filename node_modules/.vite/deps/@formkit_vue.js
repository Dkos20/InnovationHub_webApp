  ...
  const store = new Proxy(messages3, {
    get(...args) {
      ...
      if (has(storeTraps, property)) {
        return storeTraps[property].bind(null, messages3, store, node);
      }
...
function setMessage(messageStore, store, node, message3) {
  ...
  if (messageStore[message3.key] !== message3) {
    ...
    messageStore[message3.key] = Object.freeze(node.hook.message.dispatch(message3));
...
function applyMessages(_messageStore, store, node, messages3, clear) {
  if (Array.isArray(messages3)) {
    ...
    const applied = new Set(messages3.map((message3) => {
      store.set(message3);
      return message3.key;
    }));
    if (typeof clear === "string") {
      store.filter((message3) => message3.type !== clear || applied.has(message3.key));
...
function missed(node, store, address, messages3, clear) {
  ...
  (_a = misses.get(address)) === null || _a === void 0 ? void 0 : _a.push([messages3, clear]);
}
...
function setErrors$1(node, _context, localErrors, childErrors) {
  ...
  createMessages(node, errors2.localErrors, errors2.childErrors).forEach((errors3) => {
    node.store.apply(errors3, (message3) => message3.meta.source === sourceKey);
  });
  return node;
}
...
var FORMKIT_VERSION = "1.0.0-beta.14";
      ...
      prop.value = prop.value.map((option2) => {
        ...
        if (!((_a = option2.attrs) === null || _a === void 0 ? void 0 : _a.id)) {
          return extend(option2, {
            attrs: { id: `${node.name}-option-${slugify(String(option2.value))}` }
          });
        }
        return option2;
      });
